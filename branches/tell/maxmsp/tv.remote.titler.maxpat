...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 321.0, 485.0, 36.0, 21.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 293.5, 578.0, 104.0, 21.0 ],
					"text" : "prepend mypath"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 184.0, 400.0, 43.0, 18.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 635.0, 666.0, 136.0, 18.0 ],
					"text" : "Logfile",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 332.5, 551.0, 55.0, 19.0 ],
					"text" : "compile"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 447.0, 578.0, 79.0, 21.0 ],
					"text" : "prepend log"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 497.5, 496.5, 92.0, 21.0 ],
					"presentation_rect" : [ 501.0, 497.5, 0.0, 0.0 ],
					"text" : "v master_time"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 402.0, 496.5, 92.0, 21.0 ],
					"text" : "v master_time"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "" ],
					"patching_rect" : [ 519.0, 470.0, 49.0, 21.0 ],
					"text" : "sel 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 447.0, 551.0, 70.0, 21.0 ],
					"text" : "pack 0 0 s"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 249.0, 551.0, 35.0, 19.0 ],
					"presentation_rect" : [ 246.0, 551.0, 0.0, 0.0 ],
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 208.0, 551.0, 36.0, 19.0 ],
					"text" : "start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "" ],
					"patching_rect" : [ 205.0, 492.0, 49.0, 21.0 ],
					"text" : "sel 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 227.0, 400.0, 20.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 604.0, 666.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 203.0, 636.0, 94.0, 21.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
					"text" : "js tv.titler.log.js"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 409.0, 667.0, 92.0, 21.0 ],
					"text" : "v master_time"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 508.5, 667.0, 50.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 447.0, 629.0, 142.0, 21.0 ],
					"text" : "jit.net.recv @port 8899"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 518.0, 659.5, 418.5, 659.5 ],
					"source" : [ "obj-29", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 456.5, 617.0, 212.5, 617.0 ],
					"source" : [ "obj-67", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "/Users/me/patchesMAX5/tvtools_SVN/maxmsp",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "tv.titler.log.js",
				"bootpath" : "/Users/me/patchesMAX5/tvtools_SVN/maxmsp",
				"patcherrelativepath" : "",
				"type" : "TEXT",
				"implicit" : 1
