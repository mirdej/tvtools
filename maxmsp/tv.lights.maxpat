...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 40.0, 135.0, 84.0, 22.0 ],
									"style" : "",
									"triangle" : 0
								}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 43.0, 117.0, 150.0, 20.0 ],
					"style" : "",
					"text" : "enable faders",
...
, 			{
				"name" : "tv.lights.dimmerview.maxpat",
				"bootpath" : "~/Documents/tvtools/maxmsp",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
